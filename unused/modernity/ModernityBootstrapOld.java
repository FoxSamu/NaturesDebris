...
import modernity.server.ModernityServerOld;
...
/**
 * Bootstrap class of the Modernity, which handles setup events and creates the {@link IModernityOld} instance for the side
 * we're running on. This is {@link ModernityClientOld} for the client and {@link ModernityServerOld} for the dedicated
...
public final class ModernityBootstrapOld {
     ...
     * IModernityOld#registerListeners()}, then {@link IModernityOld#preInit()} and casts an event on the forge event bus
