...
public final class EcoBlockPos extends BlockPos.MutableBlockPos implements AutoCloseable {
    ...
    @Override
    public EcoBlockPos move( Direction facing ) {
        checkStatus();
        return (EcoBlockPos) super.move( facing );
    }

    @Override
    public EcoBlockPos move( Direction facing, int n ) {
        checkStatus();
    ...
    @Override
    public EcoBlockPos setPos( long p_218294_1_ ) {
        checkStatus();
        return (EcoBlockPos) super.setPos( p_218294_1_ );
    }

    @Override
    public EcoBlockPos func_218295_a( AxisRotation p_218295_1_, int p_218295_2_, int p_218295_3_, int p_218295_4_ ) {
        checkStatus();
        return (EcoBlockPos) super.func_218295_a( p_218295_1_, p_218295_2_, p_218295_3_, p_218295_4_ );
    }

    @Override
    public EcoBlockPos move( int xIn, int yIn, int zIn ) {
        checkStatus();
        return (EcoBlockPos) super.move( xIn, yIn, zIn );
    }
