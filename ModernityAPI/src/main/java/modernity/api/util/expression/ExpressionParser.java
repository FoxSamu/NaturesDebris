...
package modernity.api.util.expression;
...
public class ExpressionParser {
    ...
    public interface Factory {
        ...
        default IExpression threadLocal() {
    ...
    private static class ExprImpl implements IExpression {
    ...
    private static class ThreadLocalExpr implements IExpression {
        private final ThreadLocal<IExpression> expr;

        private ThreadLocalExpr(Supplier<IExpression> expr) {
