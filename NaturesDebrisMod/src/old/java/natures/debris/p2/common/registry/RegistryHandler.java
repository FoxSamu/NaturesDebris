...
import natures.debris.p2.common.item.MDItems;
...
public class RegistryHandler<E extends IForgeRegistryEntry<E>> {
    ...
    public static final RegistryHandler<Block> BLOCKS = new RegistryHandler<>("natures/debris", ForgeRegistries.BLOCKS);
    public static final RegistryHandler<Item> ITEMS = new RegistryHandler<>("natures/debris", ForgeRegistries.ITEMS);
    public static final RegistryHandler<Fluid> FLUIDS = new RegistryHandler<>("natures/debris", ForgeRegistries.FLUIDS);
    public static final BlockItemRegistryHandler BLOCKS_ITEMS = new BlockItemRegistryHandler();
    public static final RegistryHandler<SoundEvent> SOUND_EVENTS = new RegistryHandler<>("natures/debris", ForgeRegistries.SOUND_EVENTS);
    public static final RegistryHandler<ModDimension> DIMENSIONS = new RegistryHandler<>("natures/debris", ForgeRegistries.MOD_DIMENSIONS);
    public static final RegistryHandler<Biome> BIOMES = new RegistryHandler<>("natures/debris", ForgeRegistries.BIOMES);
    public static final RegistryHandler<ChunkGeneratorType<?, ?>> CHUNK_GENERATORS = new RegistryHandler<>("natures/debris", ForgeRegistries.CHUNK_GENERATOR_TYPES);
    public static final RegistryHandler<SurfaceBuilder<?>> SURFACE_BUILDERS = new RegistryHandler<>("natures/debris", ForgeRegistries.SURFACE_BUILDERS);
    ...
    public void register(IForgeRegistry<?> genericRegistry) {
        ...
        IForgeRegistry<E> registry = genericRegistry;
    ...
    public void handleMissingMappings(RegistryEvent.MissingMappings<?> genericEvent) {
        RegistryEvent.MissingMappings<E> event = genericEvent;
