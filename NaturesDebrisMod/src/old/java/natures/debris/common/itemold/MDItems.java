...
import modernity.common.itemold.base.*;
...
import natures.debris.common.itemold.base.*;
import natures.debris.common.itemold.util.ItemUtil;
...
import natures.debris.generic.item.IColoredItem;
...
public final class MDItems {
    private static final RegistryHandler<Item> ENTRIES = new RegistryHandler<>("natures/debris");
