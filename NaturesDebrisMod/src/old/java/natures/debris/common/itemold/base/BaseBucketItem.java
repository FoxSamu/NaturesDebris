...
import natures.debris.generic.block.fluid.ICustomBucketSound;
import natures.debris.generic.block.fluid.ICustomVaporize;
...
public class BaseBucketItem extends Item {
    ...
    public BaseBucketItem(Fluid fluid, Properties properties) {
        this(fluid, Items.BUCKET, Fluid::getFilledBucket, properties);
    }

    public BaseBucketItem(Fluid fluid, Item empty, Function<Fluid, Item> fluidToItem, Properties properties) {
        super(properties);
