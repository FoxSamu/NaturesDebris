...
import modernity.api.generator.fractal.CachingRegionContext;
import modernity.api.generator.fractal.IRegionRNG;
import modernity.api.generator.fractal.layer.IEdgeTransformerLayer;
import modernity.api.util.exc.InstanceOfUtilityClassException;
import modernity.api.util.math.IIntScrambler;
...
import natures.debris.common.blockold.MDMineralBlocks;
import natures.debris.common.blockold.MDNatureBlocks;
import natures.debris.common.fluidold.MDFluids;
import natures.debris.common.generator.biome.BiomeGenerator;
import natures.debris.common.generator.biome.LayerBiomeProvider;
import natures.debris.common.generator.biome.LayerBiomeProviderSettings;
import natures.debris.common.generator.biome.layer.*;
...
import natures.debris.common.generator.biome.profile.DefaultBiomeRarity;
import natures.debris.common.generator.blocks.MDBlockGenerators;
import natures.debris.common.generator.decorate.condition.IsBelowHeight;
...
import natures.debris.common.generator.decorate.position.BelowHeight;
import natures.debris.common.generator.decorate.position.BetweenHeight;
import natures.debris.common.generator.decorate.position.InCave;
import natures.debris.common.generator.decorate.position.Surface;
import natures.debris.common.generator.map.BedrockGenerator;
import natures.debris.common.generator.map.surface.*;
...
import static natures.debris.common.blockold.MDBlockPredicates.*;
...
public final class MurkSurfaceGeneration {
    ...
    public static ChunkGenerator<?> buildChunkGenerator(IWorld world) {
        ...
        return new ProceduralChunkGenerator(
            world,
            biomeGen,
            new ProceduralGenSettings<SurfaceGenData>()
    ...
    public static BiomeProvider buildBiomeProvider(IWorld world) {
        return new LayerBiomeProvider(
            new LayerBiomeProviderSettings(world.getWorldInfo())
    ...
    public static BiomeGenerator[] buildLayerProcedure(long seed) {
        ...
        context.generate(new BiomeBaseLayer(profile), 4538L)
               ...
               .export(generators, 0, BiomeGenerator::new)
               .zoomVoronoi()
               .export(generators, 1, BiomeGenerator::new);
    ...
    public static void decorate(WorldGenRegion region, ChunkGenerator<?> chunkGen) {
        ...
        Biome biome = region.getBiome(cornerPos.add(8, 0, 8));
    ...
    public static void addCavePlants(ModernityBiome biome) {
        ...
        biome.addDecorator(new DecorationDecorator(new ClusterBushDecoration(80, 8, MDBlockGenerators.GOO_DRIPS), new BetweenHeight(0, 60), new Chance(0.6)));
