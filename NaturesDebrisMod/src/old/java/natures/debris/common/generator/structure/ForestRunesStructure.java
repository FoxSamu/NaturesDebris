...
import natures.debris.common.area.ForestRunesArea;
...
import natures.debris.common.blockold.portal.HorizontalPortalFrameBlock;
import natures.debris.common.blockold.portal.PortalCornerBlock;
import natures.debris.common.blockold.portal.PortalCornerState;
import natures.debris.common.generator.structure.util.RotatingPiece;
import natures.debris.common.generator.structure.util.StructureUtil;
...
public class ForestRunesStructure extends Structure<NoFeatureConfig> {
    ...
    public boolean hasStartAt(ChunkGenerator<?> chunkGen, Random rand, int chunkPosX, int chunkPosZ, Biome biome) {
    ...
    @Override
    public boolean func_225558_a_(BiomeManager biomeManager, ChunkGenerator<?> chunkGen, Random rand, int cx, int cz, Biome biome) {
        return hasStartAt(chunkGen, rand, cx, cz, biome);
    }
    ...
    public static class Start extends StructureStart {
        public Start(Structure<?> structure, int x, int z, MutableBoundingBox box, int ref, long seed) {
            super(structure, x, z, box, ref, seed);
        }
    ...
    public static class Piece extends RotatingPiece {
        ...
        @Override
        public boolean func_225577_a_(IWorld world, ChunkGenerator<?> chunkGen, Random rand, MutableBoundingBox box, ChunkPos chunkPos) {
            return addComponentParts(world, rand, box, chunkPos);
        }
