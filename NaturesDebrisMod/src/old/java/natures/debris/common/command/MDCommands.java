...
import natures.debris.common.command.argument.DimensionArgumentType;
import natures.debris.common.command.argument.EnumArgumentType;
import natures.debris.common.command.node.ResourceLiteralArgumentBuilder;
import natures.debris.generic.MDInfo;
import natures.debris.generic.event.ModernityCommandSetupEvent;
import natures.debris.generic.event.ModernityDebugCommandSetupEvent;
...
public final class MDCommands {
    ...
    public static void register(CommandDispatcher<CommandSource> dispatcher) {
        ...
        register("natures/debris", dispatcher, commandList);
