...
// TODO Re-evaluate: Forge has this command to, should we remove this?
...
//    }
    ...
    private static int teleport(CommandSource source, DimensionType dim) {
        ...
        pl.teleport(pl.server.getWorld(dim), e.getPosX(), e.getPosY(), e.getPosZ(), e.rotationYaw, e.rotationPitch);
