...
import modernity.util.SimpleAsyncExecutor;
import natures.debris.ModernityBootstrapOld;
import natures.debris.common.advancements.MDCriteriaTriggers;
import natures.debris.common.area.core.IWorldAreaManager;
import natures.debris.common.area.core.ServerWorldAreaManager;
import natures.debris.common.blockold.dispensing.MDDispenseBehaviors;
import natures.debris.common.capability.MDCapabilities;
import natures.debris.common.command.MDCommands;
import natures.debris.common.generator.structure.MDStructurePieceTypes;
import natures.debris.common.generator.structure.MDStructures;
import natures.debris.common.handler.*;
import natures.debris.common.loot.MDLootTables;
import natures.debris.common.net.MDPackets;
...
import natures.debris.generic.dimension.IInitializeDimension;
 ...
 *
 * @author RGSW
 * @see ModernityBootstrapOld
 */
public abstract class ModernityOld implements IModernityOld {
    ...
    public static final IEventBus EVENT_BUS = IModernityOld.EVENT_BUS;
    ...
    /**
     * Returns the only instance of the {@link ModernityOld} class.
     */
    public static ModernityOld get() {
        return (ModernityOld) IModernityOld.get();
    }
    ...
    /**
     * Called after creating the {@link ModernityOld} instance and after {@link #registerListeners()} to initalize
     * things that need to be initialized as early as possible.
     */
    @Override
    public void preInit() {
    ...
    public void init() {
        ...
        Biomes.DARK_FOREST.addStructure(MDStructures.FOREST_RUNES.withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG));
        Biomes.DARK_FOREST_HILLS.addStructure(MDStructures.FOREST_RUNES.withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG));
        ...
        for (Biome biome : biomes) {
            biome.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, MDStructures.FOREST_RUNES.withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG).withPlacement(Placement.NOPE.configure(IPlacementConfig.NO_PLACEMENT_CONFIG)));
        }
