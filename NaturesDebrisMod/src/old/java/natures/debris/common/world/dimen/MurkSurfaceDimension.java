...
import natures.debris.client.environment.LightUtil;
...
import natures.debris.common.environment.event.impl.PrecipitationEnvEvent;
import natures.debris.common.environment.precipitation.IPrecipitation;
import natures.debris.common.environment.precipitation.IPrecipitationFunction;
import natures.debris.common.environment.satellite.SatelliteData;
...
import natures.debris.generic.dimension.IPrecipitationDimension;
import natures.debris.generic.dimension.IShaderDimension;
 ...
 */
public class MurkSurfaceDimension extends Dimension implements IClientTickingDimension, IInitializeDimension, IPrecipitationDimension, IShaderDimension { // , IEnvironmentDimension, ISatelliteDimension, IEnvEventsDimension, ISoundEffectDimension
