...
import natures.debris.api.util.math.ILongScrambler;
...
public class CachingRegionBuilder implements IRegionBuilder<CachingRegion, CachingRegionBuilder> {
    ...
    private static final ILongScrambler DEFAULT_SCRAMBLER = ILongScrambler.xorshift(13, -17, 5, -23, 19, -7).masked(0xFFFFL);
