...
import natures.debris.api.generator.fractal.layer.*;
...
public interface IRegionBuilder<R extends IRegion, T extends IRegionBuilder<R, T>> extends IRegionFactory<R> {
    ...
    /**
     * Builds a {@link IRegion} and creates a {@link FractalGenerator} instance, which is then passed as parameter to
    ...
    default <D extends FractalGenerator<?>> T export(Consumer<? super D> consumer, Function<IRegion, ? extends D> factory) {
        consumer.accept(makeGenerator(factory));
        return (T) this;
    }

    /**
     * Builds a {@link IRegion} and creates a {@link FractalGenerator} instance, which is then set in an array at the
     * specified index.
     *
     ...
     */
    @SuppressWarnings("unchecked")
    default <D extends FractalGenerator<?>> T export(D[] arr, int index, Function<IRegion, ? extends D> factory) {
