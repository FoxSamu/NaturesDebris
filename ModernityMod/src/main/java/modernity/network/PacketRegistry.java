...
public class PacketRegistry {
    ...
    public int register( Class<? extends Packet> packetClass ) {
        ...
        Constructor<? extends Packet> constructor = constructor( packetClass );
    ...
    /**
     * Registers a packet class to this registry, by calling {@link Packet#getClass()} on the specified packet. This
     ...
     */
    public int register( Packet pkt ) {
        if( pkt == null ) {
            throw new NullPointerException( "Packet to be registered was null" );
        }
     ...
     */
    public <T extends Packet> int register( Class<T> packetClass, Supplier<T> factory ) {
        if( packetClass == null ) {
            throw new NullPointerException( "Packet to be registered was null" );
        }
        if( factory == null ) {
     ...
     */
    @Nullable
    public Class<? extends Packet> getPacketClass( @Nonnegative int id ) {
    ...
    public Packet getPacket( @Nonnegative int id ) {
        if( id < 0 ) {
        ...
        Packet constructed = constructors.get( id ).get();
        if( constructed == null ) {
    ...
    private Constructor<? extends Packet> constructor( Class<? extends Packet> pktClass ) {
