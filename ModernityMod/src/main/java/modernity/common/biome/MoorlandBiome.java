...
public class MoorlandBiome extends ModernityBiome {
    protected MoorlandBiome( Type type ) {
        ...
        addDecorator( new DecorationDecorator( new LakeDecoration( MDNatureBlocks.MURKY_WATER, null, null, MDNatureBlocks.HEATH_BLOCK ), new FixedHeight( 128 ), new Chance( 0.1 ) ) );
