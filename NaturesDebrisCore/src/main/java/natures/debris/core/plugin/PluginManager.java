...
import natures.debris.api.event.NdEventBusSubscriber;
...
public final class PluginManager {
    private static final Logger LOGGER = LogManager.getLogger("Nature's Debris Plugin Manager");
    ...
    private static final Type PLUGIN_ANNOTATION = Type.getType(NaturesDebrisPlugin.class);
    private static final Type EVENT_SUB_ANNOTATION = Type.getType(NdEventBusSubscriber.class);
    ...
    /**
     * Loads all Nature's Debris plugins (classes annotated with {@link NaturesDebrisPlugin @NaturesDebrisPlugin}) and
     * all Nature's Debris event bus subscribers (classes annotated with {@link NdEventBusSubscriber
     *
     * @NdEventBusSubscriber}). This uses Forge's {@link ModFileScanData} to find annotated classes.
     */
    public static void loadPlugins() {
        ...
        for (ASMPluginData data : EVENT_SUB_ASM) {
            try {
                ...
                LOGGER.error("Unable to create NdEventBusSubscriber: " + exc.getMessage());
            }
        }
    ...
    /**
     * Analyzes the {@link ModFileScanData} for {@link NaturesDebrisPlugin @NaturesDebrisPlugin} annotations.
     */
