...
public class SSpawnEntityPacket implements Packet {
    ...
    public SSpawnEntityPacket( Entity entity, int data ) {
        this( entity.getEntityId(), entity.getUniqueID(), entity.posX, entity.posY, entity.posZ, entity.rotationPitch, entity.rotationYaw, entity.getType(), data, entity.getMotion() );
    }
