...
public class ShadeBallEntity extends ThrownItemEntity {
    ...
    protected void onImpact( RayTraceResult result ) {
        ...
        // Spawn particles
        for( int i = 0; i < 32; ++ i ) {
            world.addParticle( MDParticleTypes.SHADE, posX, posY + rand.nextDouble() * 2, posZ, rand.nextGaussian(), 0, rand.nextGaussian() );
        }
        ...
        if( ! world.isRemote ) {
            if( thrower instanceof ServerPlayerEntity ) {
                ...
                EnderTeleportEvent event = new EnderTeleportEvent( player, posX, posY, posZ, 5 );
