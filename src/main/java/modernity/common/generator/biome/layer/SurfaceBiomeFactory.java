 ...
 */
public class SurfaceBiomeFactory<T extends IArea> implements IAreaFactory<T> {

    private final MDBiomes.GenProfile profile;
    private final IExtendedNoiseRandom<T> context;

    public SurfaceBiomeFactory( EMDDimension dimen, IExtendedNoiseRandom<T> context ) {
