...
public class SurfaceSurfaceBuilder {
    ...
    public SurfaceSurfaceBuilder( IWorld world, BiomeProvider biomeGen, SurfaceGenSettings settings ) {
        this.world = world;
        ...
        for( ModernityBiome biome : MDBiomes.getBiomesFor( EMDDimension.SURFACE ) ) {
            ...
            if( type[ 0 ] == SurfaceGenSettings.class ) {
