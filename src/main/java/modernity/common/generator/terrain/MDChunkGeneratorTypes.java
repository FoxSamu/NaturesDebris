...
package modernity.common.generator.terrain;
...
public final class MDChunkGeneratorTypes {
    ...
    public static final ChunkGeneratorType<SurfaceGenSettings, SurfaceGenerator> SURFACE = register( "surface", new ChunkGeneratorType<>( new SurfaceGenerator.Factory(), false, SurfaceGenSettings::new ) );
