...
public class LushMeadowBiome extends ModernityBiome {
    protected LushMeadowBiome( Type type ) {
        super( type.builder );
        ...
        addDecorator( new DecorationDecorator( new GroupedBushDecoration( 3, 5, 4, MDBlockGenerators.REDWOLD ), new Surface( Heightmap.Type.WORLD_SURFACE_WG ), new Chance( 0.5 ) ) );
        ...
        addDecorator( new DecorationDecorator( new ClusterBushDecoration( 120, 6, MDBlockGenerators.MURK_GRASS_LUSH ), new Surface( Heightmap.Type.MOTION_BLOCKING ), new Fixed( 24 ) ) );
