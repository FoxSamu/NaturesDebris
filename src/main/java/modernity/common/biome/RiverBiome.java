...
public class RiverBiome extends BiomeBase {
    public RiverBiome() {
        ...
        addFeature( GenerationStage.Decoration.VEGETAL_DECORATION, createCompositeFeature( MDFeatures.GROUPED_BUSH, new GroupedBushFeature.Config( 3, 5, 4, MDBlocks.REEDS ), TOP_SOLID_ONCE, IPlacementConfig.NO_PLACEMENT_CONFIG ) );
