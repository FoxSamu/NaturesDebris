...
public class ModernityCaveGenerator {
    ...
    public ModernityCaveGenerator( World world, BiomeProvider provider, ModernityGenSettings settings ) {
        this.world = world;
                        ...
                        for( int xo = 0; xo < 2; xo++ ) {
                            ...
                            for( int zo = 0; zo < 2; zo++ ) {
                                ...
                                for( int yo = 0; yo < 1; yo++ ) {
                                    ...
                                    IBlockState state = region.getBlockState( rpos );
                                    if( noise < BASE_LIMIT && state.getBlock() != MDBlocks.MODERN_BEDROCK ) {
                                        region.setBlockState( rpos, by > 16 ? Blocks.CAVE_AIR.getDefaultState() : MDBlocks.MODERNIZED_WATER.getDefaultState(), false );
                                    }
                                }
