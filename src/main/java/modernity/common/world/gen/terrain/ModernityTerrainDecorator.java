...
public class ModernityTerrainDecorator {
    ...
    public ModernityTerrainDecorator( World world, BiomeProvider provider, IChunkGenerator chunkgen, ModernityGenSettings settings ) {
        ...
        addFeature( GenerationStage.Decoration.UNDERGROUND_ORES, createCompositeFeature( Feature.MINABLE, new MinableConfig( BlockMatcher.forBlock( MDBlocks.ROCK_SLAB ), MDBlocks.SALT_ORE.getDefaultState(), 15 ), Biome.HEIGHT_BIASED_RANGE, new CountRangeConfig( 17, 4, 4, 128 ) ) );
        addFeature( GenerationStage.Decoration.UNDERGROUND_ORES, createCompositeFeature( Feature.MINABLE, new MinableConfig( BlockMatcher.forBlock( MDBlocks.ROCK_SLAB ), MDBlocks.ALUMINIUM_ORE.getDefaultState(), 9 ), Biome.HEIGHT_BIASED_RANGE, new CountRangeConfig( 11, 4, 4, 128 ) ) );
