...
public class ModernityTerrainDecorator {
    ...
    public ModernityTerrainDecorator( World world, BiomeProvider provider, IChunkGenerator chunkgen, ModernityGenSettings settings ) {
        ...
        addFeature( GenerationStage.Decoration.UNDERGROUND_ORES, createCompositeFeature( Feature.MINABLE, new MinableConfig( BlockPredicates.ROCK_TYPES, MDBlocks.LIMESTONE.getDefaultState(), 40 ), MDPlacements.IN_CAVE_WITH_FREQUENCY, new FrequencyConfig( 3 ) ) );
        addFeature( GenerationStage.Decoration.UNDERGROUND_ORES, createCompositeFeature( Feature.MINABLE, new MinableConfig( BlockMatcher.forBlock( MDBlocks.ROCK ), MDBlocks.SALT_ORE.getDefaultState(), 15 ), Biome.HEIGHT_BIASED_RANGE, new CountRangeConfig( 17, 4, 4, 128 ) ) );
        addFeature( GenerationStage.Decoration.UNDERGROUND_ORES, createCompositeFeature( Feature.MINABLE, new MinableConfig( BlockMatcher.forBlock( MDBlocks.ROCK ), MDBlocks.ALUMINIUM_ORE.getDefaultState(), 9 ), Biome.HEIGHT_BIASED_RANGE, new CountRangeConfig( 11, 4, 4, 128 ) ) );
        addFeature( GenerationStage.Decoration.UNDERGROUND_ORES, createCompositeFeature( Feature.MINABLE, new MinableConfig( BlockMatcher.forBlock( MDBlocks.ROCK ), MDBlocks.ANTHRACITE_ORE.getDefaultState(), 15 ), Biome.HEIGHT_BIASED_RANGE, new CountRangeConfig( 20, 4, 4, 128 ) ) );
