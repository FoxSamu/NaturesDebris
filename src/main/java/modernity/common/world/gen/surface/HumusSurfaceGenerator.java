...
public class HumusSurfaceGenerator implements ISurfaceGenerator<ModernityGenSettings> {

    private static final IBlockState HUMUS = MDBlocks.HUMUS.getDefaultState();
