...
public abstract class RegularFluid extends Fluid {
     ...
     */
    protected IFluidState calculateCorrectState( IEnviromentBlockReader world, BlockPos pos, BlockState state, IFluidState origin ) {
        int maxLevel = 0;
     ...
     */
    protected int findSlope( IEnviromentBlockReader world, BlockPos pos, int recursion, Direction facing, BlockState state, BlockPos adjPos, Short2ObjectMap<Pair<BlockState, IFluidState>> blockFluidMap, Short2BooleanMap slopeMap ) {
        int weight = 1000;
