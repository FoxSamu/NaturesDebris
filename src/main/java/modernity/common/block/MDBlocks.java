...
public class MDBlocks {
    ...
    public static final BlockBase LIMESTONE = blockItem( new BlockBase( "limestone", Block.Properties.create( Material.ROCK, MaterialColor.WHITE_TERRACOTTA ).hardnessAndResistance( 1, 4 ).sound( SoundType.STONE ), new Item.Properties().group( MDItemGroups.BLOCKS ) ) );
    ...
    public static final BlockBase ASPHALT_CONCRETE = blockItem( new BlockBase( "asphalt_concrete", Block.Properties.create( MDMaterial.ASPHALT, MaterialColor.BLACK ).hardnessAndResistance( 1, 4 ).sound( SoundType.STONE ), new Item.Properties().group( MDItemGroups.BLOCKS ) ) );
    ...
    public static final BlockSlab LIMESTONE_SLAB = blockItem( new BlockSlab( "limestone_slab", Block.Properties.create( Material.ROCK, MaterialColor.WHITE_TERRACOTTA ).hardnessAndResistance( 1, 4 ).sound( SoundType.STONE ), new Item.Properties().group( MDItemGroups.BLOCKS ) ) );
    ...
    public static final BlockStairs LIMESTONE_STAIRS = blockItem( new BlockStairs( "limestone_stairs", false, Block.Properties.create( Material.ROCK, MaterialColor.WHITE_TERRACOTTA ).hardnessAndResistance( 1, 4 ).sound( SoundType.STONE ), new Item.Properties().group( MDItemGroups.BLOCKS ) ) );
    ...
    public static final BlockStairs LIMESTONE_STEP = blockItem( new BlockStairs( "limestone_step", true, Block.Properties.create( Material.ROCK, MaterialColor.WHITE_TERRACOTTA ).hardnessAndResistance( 1, 4 ).sound( SoundType.STONE ), new Item.Properties().group( MDItemGroups.BLOCKS ) ) );
    ...
    public static final BlockCorner LIMESTONE_CORNER = blockItem( new BlockCorner( "limestone_corner", Block.Properties.create( Material.ROCK, MaterialColor.WHITE_TERRACOTTA ).hardnessAndResistance( 1, 4 ).sound( SoundType.STONE ), new Item.Properties().group( MDItemGroups.BLOCKS ) ) );
    ...
    public static final BlockWall LIMESTONE_WALL = blockItem( new BlockWall( "limestone_wall", Block.Properties.create( Material.ROCK, MaterialColor.WHITE_TERRACOTTA ).hardnessAndResistance( 1, 4 ).sound( SoundType.STONE ), new Item.Properties().group( MDItemGroups.BLOCKS ) ) );
    ...
    public static final BlockDoor ALUMINIUM_DOOR = blockItem( new BlockDoor( "aluminium_door", Block.Properties.create( Material.IRON, MaterialColor.IRON ).hardnessAndResistance( 5, 6 ).sound( SoundType.METAL ), new Item.Properties().group( MDItemGroups.BLOCKS ) ) );
    ...
    // Dusts
    public static final BlockFall ASH_BLOCK = blockItem( new BlockFallDigable( "ash_block", 0x333333, Block.Properties.create( MDMaterial.ASH, MaterialColor.GRAY ).hardnessAndResistance( 0.4F ).sound( SoundType.SAND ), new Item.Properties().group( MDItemGroups.BLOCKS ) ) );
    public static final BlockFall SALT_DUST_BLOCK = blockItem( new BlockFallDigable( "salt_dust_block", 0xffffff, Block.Properties.create( Material.SAND, MaterialColor.SNOW ).hardnessAndResistance( 0.4F ).sound( SoundType.SAND ), new Item.Properties().group( MDItemGroups.BLOCKS ) ) );
    ...
    public static final BlockFallDigable DARK_SAND = blockItem( new BlockFallDigable( "dark_sand", 0x584c39, Block.Properties.create( Material.SAND, MaterialColor.SAND ).hardnessAndResistance( 0.5F ).sound( SoundType.SAND ), new Item.Properties().group( MDItemGroups.BLOCKS ) ) );
    public static final BlockDigable DARK_CLAY = blockItem( new BlockDigable( "dark_clay", Block.Properties.create( Material.CLAY, MaterialColor.GRAY_TERRACOTTA ).hardnessAndResistance( 0.5F ).sound( SoundType.GROUND ), new Item.Properties().group( MDItemGroups.BLOCKS ) ) );
    ...
    public static final BlockSticky MUD = blockItem( new BlockSticky.Digable( "mud", Block.Properties.create( Material.GROUND, MaterialColor.ORANGE_TERRACOTTA ).hardnessAndResistance( 0.6F ).sound( SoundType.PLANT ), new Item.Properties().group( MDItemGroups.BLOCKS ) ) );
    public static final BlockFallDigable ROCK_GRAVEL = blockItem( new BlockFallDigable( "rock_gravel", 0x584c39, Block.Properties.create( Material.SAND, MaterialColor.SAND ).hardnessAndResistance( 0.5F ).sound( SoundType.GROUND ), new Item.Properties().group( MDItemGroups.BLOCKS ) ) );
    ...
    public static final BlockSinglePlant REDWOLD = blockItem( new BlockSinglePlant.Redwold( "redwold", Block.Properties.create( Material.VINE, MaterialColor.GRASS ).doesNotBlockMovement().hardnessAndResistance( 0 ).sound( SoundType.PLANT ), new Item.Properties().group( MDItemGroups.BLOCKS ) ) );
    ...
    public static final BlockOre ANTHRACITE_ORE = blockItem( new BlockOre.Anthracite( "anthracite_ore", Block.Properties.create( Material.ROCK, MaterialColor.STONE ).hardnessAndResistance( 2F, 6F ).sound( SoundType.STONE ), new Item.Properties().group( MDItemGroups.BLOCKS ) ) );
    ...
    public static final BlockBase ANTHRACITE_BLOCK = blockItem( new BlockBase( "anthracite_block", Block.Properties.create( Material.ROCK, MaterialColor.BLACK ).hardnessAndResistance( 3F, 6F ).sound( SoundType.STONE ), new Item.Properties().group( MDItemGroups.BLOCKS ) ) );
