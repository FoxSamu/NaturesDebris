...
public class MDBlocks {
    ...
    public static final BlockDecayLeaves INVER_LEAVES = blockItem( new BlockDecayLeaves.ColoredInver( "inver_leaves", MDBlockTags.BLACKWOOD_LOG, BLACKWOOD_SAPLING, Block.Properties.create( Material.LEAVES ).hardnessAndResistance( 0.2F ).tickRandomly().sound( SoundType.PLANT ), new Item.Properties().group( MDItemGroups.BLOCKS ) ) );
