...
public class BlockStripable extends BlockBase {
    private final Block result;

    public BlockStripable( String id, Block result, Properties properties, Item.Properties itemProps ) {
        super( id, properties, itemProps );
        this.result = result;
    }

    public BlockStripable( String id, Block result, Properties properties ) {
        super( id, properties );
        this.result = result;
    }
