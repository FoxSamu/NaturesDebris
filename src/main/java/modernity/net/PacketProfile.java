...
public class PacketProfile {
     ...
     */
    public int registerPacket( ESide side, Class<? extends IPacket> packet ) {
     ...
     */
    public <T extends IPacket> int registerPacket( ESide side, Class<T> packet, Supplier<T> factory ) {
        if( side == null ) throw new NullPointerException();
