...
public class LaunchTesting {
    ...
    /**
     * Basic implementation of Mojang's 'Yggdrasil' login system, purely intended as a dev time bare bones login. Login
     * errors are not handled. Do not use this unless you know what you are doing and must use it to debug things
     * REQUIRING authentication. Forge is not responsible for any auth information passed in, saved to logs, run
     * configs, etc... BE CAREFUL WITH YOUR LOGIN INFO
     */
