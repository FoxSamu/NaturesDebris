        ...
        return new IIngredientData() {
            ...
            public void addItemCriteria( BiConsumer<String, ItemPredicate> consumer, MinMaxBounds.IntBound count ) {
                consumer.accept(
                    ...
                    ItemPredicate.Builder.create().item( provider ).count( count ).build()
                );
            }
        };
    }
        ...
        return new IIngredientData() {
            ...
            public void addItemCriteria( BiConsumer<String, ItemPredicate> consumer, MinMaxBounds.IntBound count ) {
                consumer.accept(
                    ...
                    ItemPredicate.Builder.create().item( provider.get() ).count( count ).build()
                );
            }
        };
    }
        ...
        return new IIngredientData() {
            ...
            public void addItemCriteria( BiConsumer<String, ItemPredicate> consumer, MinMaxBounds.IntBound count ) {
                consumer.accept(
                    ...
                    ItemPredicate.Builder.create().tag( tag ).count( count ).build()
                );
            }
        };
    }
